...
public class AccountOverviewController {
  ...
  @FXML private TableColumn<Transaction, String> payeeColumn;

  @FXML private TableColumn<Transaction, Category> categoryColumn;

  @FXML private TableColumn<Transaction, String> memoColumn;

  @FXML private TableColumn<Transaction, BigDecimal> outflowColumn;
  ...
  @FXML private ListView<Command> commandLogView;
  ...
  public void setCommandRegistry(CommandRegistry commandRegistry) {
    ...
    commandLogView.setCellFactory(
        lv ->
            new ListCell<Command>() {
